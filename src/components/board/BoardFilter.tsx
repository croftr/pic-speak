                ...
                <div className="max-w-7xl mx-auto mb-4 sm:mb-6 px-1">
                    <div className="flex gap-2 overflow-x-auto pb-1 scrollbar-hide">
                        <button
                            ...
                            className={clsx(
                                "px-4 py-2 min-h-[40px] rounded-full text-sm font-bold transition-all active:scale-95 whitespace-nowrap flex-shrink-0 touch-manipulation",
                                categoryFilter === 'All'
                                    ? "bg-primary text-primary-foreground shadow-md shadow-primary/20"
                                    : "bg-white dark:bg-slate-800 text-gray-600 dark:text-gray-300 border border-gray-200 dark:border-gray-700 hover:border-primary/40"
                            )}
                        >
                            All ({cards.length})
                        </button>
