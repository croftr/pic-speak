...
function PublicBoardsContent() {
    ...
    if (isLoadingBoards) {
        return <div className="py-20 text-center text-gray-500">Loading public boards...</div>;
    }
            ...
            <div className="max-w-7xl mx-auto px-6">
                <div className="mb-12">
                    ...
                    <h1 className="text-4xl md:text-5xl font-black text-gray-900 dark:text-white mb-4">
                        {creatorFilter ? `Boards by Creator` : 'Explore Public Boards'}
                    </h1>
                ...
                <Suspense fallback={<div className="py-20 text-center text-gray-500">Loading boards...</div>}>
                    <PublicBoardsContent />
                </Suspense>
            </div>
        </main>
