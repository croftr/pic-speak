...
const STARTER_CARDS: Record<string, Card[]> = {
    ...
    'starter-school-classroom': [
        ...
        { id: 'sbp-school-13', boardId: 'starter-school-classroom', label: 'Confused', imageUrl: '/prebuilt/i_dont_understand.webp', audioUrl: '/prebuilt/i_dont_understand.wav', category: 'Core', order: 12, templateKey: 'tpl-i-dont-understand' },
        { id: 'sbp-school-14', boardId: 'starter-school-classroom', label: 'Break', imageUrl: '/prebuilt/i_need_a_break.webp', audioUrl: '/prebuilt/i_need_a_break.wav', category: 'Core', order: 13, templateKey: 'tpl-i-need-a-break' },
        { id: 'sbp-school-15', boardId: 'starter-school-classroom', label: 'Repeat', imageUrl: '/prebuilt/repeat_that.webp', audioUrl: '/prebuilt/repeat_that.wav', category: 'Core', order: 14, templateKey: 'tpl-repeat-that' },
        { id: 'sbp-school-16', boardId: 'starter-school-classroom', label: 'Finished', imageUrl: '/prebuilt/im_done.webp', audioUrl: '/prebuilt/im_done.wav', category: 'Core', order: 15, templateKey: 'tpl-im-done' },
        { id: 'sbp-school-17', boardId: 'starter-school-classroom', label: 'Tablet', imageUrl: '/prebuilt/tablet.webp', audioUrl: '/prebuilt/tablet.wav', category: 'Activities', order: 16, templateKey: 'tpl-tablet' },
        { id: 'sbp-school-18', boardId: 'starter-school-classroom', label: 'Backpack', imageUrl: '/prebuilt/backpack.webp', audioUrl: '/prebuilt/backpack.wav', category: 'Activities', order: 17, templateKey: 'tpl-backpack' },
        { id: 'sbp-school-19', boardId: 'starter-school-classroom', label: 'Desk', imageUrl: '/prebuilt/desk.webp', audioUrl: '/prebuilt/desk.wav', category: 'Places', order: 18, templateKey: 'tpl-desk' },
        { id: 'sbp-school-20', boardId: 'starter-school-classroom', label: 'Library', imageUrl: '/prebuilt/library.webp', audioUrl: '/prebuilt/library.wav', category: 'Places', order: 19, templateKey: 'tpl-library' },
        { id: 'sbp-school-21', boardId: 'starter-school-classroom', label: 'Cafeteria', imageUrl: '/prebuilt/cafeteria.webp', audioUrl: '/prebuilt/cafeteria.wav', category: 'Places', order: 20, templateKey: 'tpl-cafeteria' },
        { id: 'sbp-school-22', boardId: 'starter-school-classroom', label: 'Gym', imageUrl: '/prebuilt/gym.webp', audioUrl: '/prebuilt/gym.wav', category: 'Places', order: 21, templateKey: 'tpl-gym' },
        { id: 'sbp-school-23', boardId: 'starter-school-classroom', label: 'Listen', imageUrl: '/prebuilt/listen.webp', audioUrl: '/prebuilt/listen.wav', category: 'Activities', order: 22, templateKey: 'tpl-listen' },
        { id: 'sbp-school-24', boardId: 'starter-school-classroom', label: 'Math', imageUrl: '/prebuilt/math.webp', audioUrl: '/prebuilt/math.wav', category: 'Activities', order: 23, templateKey: 'tpl-math' },
        { id: 'sbp-school-25', boardId: 'starter-school-classroom', label: 'Art', imageUrl: '/prebuilt/art.webp', audioUrl: '/prebuilt/art.wav', category: 'Activities', order: 24, templateKey: 'tpl-art' },
    ],
    ...
    'starter-park-playground': [
        ...
        { id: 'sbp-park-13', boardId: 'starter-park-playground', label: 'Push', imageUrl: '/prebuilt/push_me.webp', audioUrl: '/prebuilt/push_me.wav', category: 'Activities', order: 12, templateKey: 'tpl-push-me' },
        ...
        { id: 'sbp-park-15', boardId: 'starter-park-playground', label: 'Watch', imageUrl: '/prebuilt/watch_me.webp', audioUrl: '/prebuilt/watch_me.wav', category: 'Social', order: 14, templateKey: 'tpl-watch-me' },
        { id: 'sbp-park-26', boardId: 'starter-park-playground', label: 'Ready', imageUrl: '/prebuilt/ready.webp', audioUrl: '/prebuilt/ready.wav', category: 'Activities', order: 15, templateKey: 'tpl-ready' },
        { id: 'sbp-park-27', boardId: 'starter-park-playground', label: 'Steady', imageUrl: '/prebuilt/steady.webp', audioUrl: '/prebuilt/steady.wav', category: 'Activities', order: 16, templateKey: 'tpl-steady' },
        { id: 'sbp-park-16', boardId: 'starter-park-playground', label: 'Go', imageUrl: '/prebuilt/ready_set_go.webp', audioUrl: '/prebuilt/ready_set_go.wav', category: 'Activities', order: 17, templateKey: 'tpl-ready-set-go' },
        { id: 'sbp-park-17', boardId: 'starter-park-playground', label: 'Sandbox', imageUrl: '/prebuilt/sandbox.webp', audioUrl: '/prebuilt/sandbox.wav', category: 'Places', order: 18, templateKey: 'tpl-sandbox' },
        { id: 'sbp-park-18', boardId: 'starter-park-playground', label: 'Seesaw', imageUrl: '/prebuilt/seesaw.webp', audioUrl: '/prebuilt/seesaw.wav', category: 'Activities', order: 19, templateKey: 'tpl-seesaw' },
        { id: 'sbp-park-19', boardId: 'starter-park-playground', label: 'Monkey bars', imageUrl: '/prebuilt/monkey_bars.webp', audioUrl: '/prebuilt/monkey_bars.wav', category: 'Activities', order: 20, templateKey: 'tpl-monkey-bars' },
        { id: 'sbp-park-20', boardId: 'starter-park-playground', label: 'Bench', imageUrl: '/prebuilt/bench.webp', audioUrl: '/prebuilt/bench.wav', category: 'Places', order: 21, templateKey: 'tpl-bench' },
        { id: 'sbp-park-21', boardId: 'starter-park-playground', label: 'Play', imageUrl: '/prebuilt/lets_play.webp', audioUrl: '/prebuilt/lets_play.wav', category: 'Social', order: 22, templateKey: 'tpl-lets-play' },
        { id: 'sbp-park-22', boardId: 'starter-park-playground', label: 'Fun', imageUrl: '/prebuilt/fun.webp', audioUrl: '/prebuilt/fun.wav', category: 'Descriptive', order: 23, templateKey: 'tpl-fun' },
        { id: 'sbp-park-23', boardId: 'starter-park-playground', label: 'Fast', imageUrl: '/prebuilt/too_fast.webp', audioUrl: '/prebuilt/too_fast.wav', category: 'Descriptive', order: 24, templateKey: 'tpl-too-fast' },
        { id: 'sbp-park-24', boardId: 'starter-park-playground', label: 'Hot', imageUrl: '/prebuilt/hot.webp', audioUrl: '/prebuilt/hot.wav', category: 'Descriptive', order: 25, templateKey: 'tpl-hot' },
        { id: 'sbp-park-25', boardId: 'starter-park-playground', label: 'Thirsty', imageUrl: '/prebuilt/thirsty.webp', audioUrl: '/prebuilt/thirsty.wav', category: 'Feelings', order: 26, templateKey: 'tpl-thirsty' }
    ]
};
