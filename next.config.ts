...
const cspDirectives = [
  ...
  "font-src 'self'",
  "connect-src 'self' https://*.clerk.com https://*.clerk.accounts.dev https://vitals.vercel-insights.com https://*.vercel-insights.com https://*.public.blob.vercel-storage.com",
